...
app.get("/rendertransactions",function(req,res){
    if (remaining < 0){
...
app.post("/update_monthly_limit",function(req,res){
    res.render("monthly_limit_page");
});

app.post("/signup/signingup",function(req,res){
...
app.post("/loggedin/update_monthly_limit/updating_monthly_limit",function(req,res){
...
app.post("/loggedin/transactions",function(req,res){
